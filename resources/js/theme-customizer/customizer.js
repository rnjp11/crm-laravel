    ...
    $(".sidebar-type li").on("click", function () {
      ...
      switch (type) {
        case "compact-sidebar": {
          ...
          $(this).addClass("active");
          localStorage.setItem("page-wrapper-crocs", "compact-wrapper");
          break;
        }
        case "normal-sidebar": {
          $(".page-wrapper").attr(
          ...
          localStorage.setItem("page-wrapper-crocs", "horizontal-wrapper");
          break;
        }
        case "default-body": {
          $(".page-wrapper").attr("class", "page-wrapper  only-body" + boxed);
          localStorage.setItem("page-wrapper-crocs", "only-body");
          break;
        }
        case "dark-sidebar": {
          $(".page-wrapper").attr(
        ...
        case "compact-wrap": {
          ...
          localStorage.setItem("page-wrapper-crocs", "compact-sidebar");
          break;
        }
        case "color-sidebar": {
          $(".page-wrapper").attr(
