(function ($) {
  ...
  var optionscolumnchart = {
    ...
    colors: [CrocsAdminConfig.secondary, "#51bb25", CrocsAdminConfig.primary],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: CrocsAdminConfig.primary,
          label: {
            borderColor: CrocsAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: CrocsAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var options = {
    ...
    legend: {
      ...
      colors: [CrocsAdminConfig.primary, '#EAEAEA'],
    fill: {
      ...
      gradient: {
        ...
        type: "vertical",
        shadeIntensity: 1,
        gradientToColors: [ CrocsAdminConfig.primary, '#fff5f7', CrocsAdminConfig.primary ],
        inverseColors: true,
        opacityFrom: 0.4,
        opacityTo: 0,
        stops: [0, 100, 100, 100],
